    ...
    <Layout>
        <div class="w-full">
            ...
            <div class="grid grid-cols-4 gap-6 px-16 mt-10">
                <div
                    class="w-full border border-slate-200 p-4 font-bold text-gray-700 hover:text-blue-600 hover:shadow-xl transition-all ease-in-out duration-500 cursor-pointer">
                    <img class="w-full h-80 object-cover" src="https://picsum.photos/400/800">
                    <div class="mt-2">
                        <p class="text-lg text-center leading-5">
                            รายวิชา GE64303 การออมและการลงทุน
                        </p>
